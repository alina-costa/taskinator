...
var taskFormHandler = function (event) {
  ...
  // check if input values are empty srtings
...
var deleteTask = function (taskId) {
  ...
  // reassign tasks array to to be the same as updatedTaskArr
...
var loadTasks = function () {
  ...
  // converts tasks from strings back into an array of objects
